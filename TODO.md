...
- Added selected-plot visibility and derived expression controls.
  ...
  - `Derived...` creates expression curves such as `d(/AttRoll)`, `smooth(/AttRoll, 100)`, `moving_average(/AttRoll, 100)`, `moving_median(/AttRoll, 100)`, `hampel(/AttRoll, 100, 3)`, `clip(/AttRoll, 20)`, and `/A - /B`.
